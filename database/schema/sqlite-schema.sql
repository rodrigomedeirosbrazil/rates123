...
CREATE TABLE IF NOT EXISTS "demands" ("id" integer primary key autoincrement not null, "begin" date not null, "end" date not null, "contacts" integer not null, "property_id" integer, "unit_id" integer, "created_at" datetime, "updated_at" datetime);
CREATE TABLE IF NOT EXISTS "properties" ("id" integer primary key autoincrement not null, "user_id" integer not null, "name" varchar not null, "street" varchar, "number" varchar, "city" varchar, "state" varchar, "country" varchar, "postal_code" varchar, "latitude" varchar, "longitude" varchar, "created_at" datetime, "updated_at" datetime, "deleted_at" datetime, foreign key("user_id") references "users"("id"));
CREATE TABLE IF NOT EXISTS "units" ("id" integer primary key autoincrement not null, "property_id" integer not null, "name" varchar not null, "base_price" numeric, "created_at" datetime, "updated_at" datetime, foreign key("property_id") references "properties"("id"));
CREATE TABLE IF NOT EXISTS "monitored_datas" ("id" integer primary key autoincrement not null, "monitored_property_id" integer not null, "price" numeric not null, "checkin" date not null, "available" tinyint(1) not null, "extra" text, "created_at" datetime, "updated_at" datetime, foreign key("monitored_property_id") references "monitored_properties"("id"));
CREATE TABLE IF NOT EXISTS "monitored_platforms" ("id" integer primary key autoincrement not null, "name" varchar not null, "slug" varchar not null, "deleted_at" datetime);
CREATE UNIQUE INDEX "monitored_platforms_slug_unique" on "monitored_platforms" ("slug");
CREATE TABLE monitored_properties (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL COLLATE "BINARY", url VARCHAR(255) NOT NULL COLLATE "BINARY", extra CLOB DEFAULT NULL COLLATE "BINARY", created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, monitored_platform_id INTEGER DEFAULT NULL, "country" varchar, "state" varchar, "city" varchar, "neighborhood" varchar, "address" varchar, "number" varchar, "complement" varchar, "postal_code" varchar, "latitude" numeric, "longitude" numeric, "hits_property_name" varchar);
CREATE TABLE IF NOT EXISTS "date_events" ("id" integer primary key autoincrement not null, "name" varchar not null, "begin" date not null, "end" date not null, "type" varchar not null, "country" varchar, "state" varchar, "city" varchar, "created_at" datetime, "updated_at" datetime);
CREATE TABLE monitored_syncs (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, monitored_property_id INTEGER NOT NULL, prices_count INTEGER NOT NULL, started_at DATETIME NOT NULL, finished_at DATETIME DEFAULT NULL, status VARCHAR(255) DEFAULT 'successful' NOT NULL COLLATE "BINARY", exception CLOB DEFAULT NULL COLLATE "BINARY", FOREIGN KEY (monitored_property_id) REFERENCES monitored_properties (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE);
CREATE INDEX IDX_35FCEDB5805DA117 ON monitored_syncs (monitored_property_id);
...
CREATE TABLE IF NOT EXISTS "user_property" ("id" integer primary key autoincrement not null, "monitored_property_id" integer not null, "user_id" integer not null, foreign key("monitored_property_id") references "monitored_properties"("id"), foreign key("user_id") references "users"("id"));
CREATE TABLE price_notifications (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, monitored_property_id INTEGER NOT NULL, checkin DATE NOT NULL, type VARCHAR(255) NOT NULL COLLATE "BINARY", created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, "before" NUMERIC(10, 0) DEFAULT NULL, "after" NUMERIC(10, 0) DEFAULT NULL, average_price NUMERIC(10, 0) DEFAULT NULL, FOREIGN KEY (monitored_property_id) REFERENCES monitored_properties (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE);
CREATE INDEX IDX_3F20F66805DA117 ON price_notifications (monitored_property_id);
CREATE TABLE IF NOT EXISTS "occupancies" ("id" integer primary key autoincrement not null, "monitored_property_id" integer not null, "checkin" date not null, "total_rooms" integer not null, "occupied_rooms" integer not null, "created_at" datetime, "updated_at" datetime, foreign key("monitored_property_id") references "monitored_properties"("id"));
